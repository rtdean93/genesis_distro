...
$databases = array (
  ...
  array (
    'default' =>
    array (
      'database' => 'PhoenixProject',
      'username' => 'phoenix',
      'password' => 'Ph03nix1',
      'host' => 'phoenixproject.cydw1wrszkso.us-east-1.rds.amazonaws.com',
      'port' => '3306',
      'driver' => 'mysql',
      'prefix' => '',
    ),
 ...
 *
 */
$drupal_hash_salt = 'O_Bwm-RyOXmJkNzwSBGSL6l1TgbRg3wVIm9iog70j_c';
 ...
 */
$cookie_domain = '.reachlocalapi.com';
...
$conf['fast_404_html'] = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML+RDFa 1.0//EN" "http://www.w3.org/MarkUp/DTD/xhtml-rdfa-1.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><title>404 Not Foundi - 404 Fast Mod</title></head><body><h1>Not Found</h1><p>The requested URL "@path" was not found on this server.</p></body></html>';
...
$conf['fast_404_HTML_error_page'] = './404/index.html';
...
$conf['nasdaqomx_domain'] = 'http://investors.reachlocal.com';

/**
 * Create the local.settings.php file to override any variables set in this file
 * there for your local development environment.
 */
